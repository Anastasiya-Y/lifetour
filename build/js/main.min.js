...
var _initSwiperAdvantages = require("./modules/swiper/init-swiper-advantages");
var _initSwiper = require("./modules/swiper/init-swiper");
var _initVideo = require("./modules/video/init-video");
var _initAudio = require("./modules/audio/init-audio");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    burger.init();
    (0, _initVideo.initVideo)();
    (0, _initAudio.initAudio)();
    (0, _initSwiper.initSwiper)();
    (0, _initSwiperAdvantages.checkBreakpoint)();
    (0, _map.createMap)();
  });
});
...
},{"./modules/audio/init-audio":2,"./modules/burger/burger":3,"./modules/form-validate/form":5,"./modules/map/map":11,"./modules/swiper/init-swiper":13,"./modules/swiper/init-swiper-advantages":12,"./modules/video/init-video":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
exports.stopAudio = void 0;
function initAudio() {
  var audio = document.querySelector('.hero__audio-wrapper');
  if (!audio) {
    return;
  }
  createAudio(audio);
...
var stopAudio = function stopAudio(element) {
  var containerElement = document.querySelector(element);
  if (containerElement) {
    var iframeTag = containerElement.querySelector('.hero__audio');
    if (iframeTag) {
...
},{"../../utils/focus-lock":15,"../../utils/scroll-lock":18}],4:[function(require,module,exports){
"use strict";
...
var createMap = function createMap() {
  ...
  }).setView([55.7748763, 37.6326415], 17);
  L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
    maxZoom: 19,
    attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
  }).addTo(map);
  var marker = L.marker([55.7748763, 37.6326415], getIconOptions()).addTo(map);
};
...
exports.checkBreakpoint = void 0;
var swiperContainerAdvantages = document.querySelector('.advantages__container');
...
var _initVideo = require("../video/init-video");
var _initAudio = require("../audio/init-audio");
var swiperContainerHero = document.querySelector('.hero__container');
var swiperContainerTours = document.querySelector('.tours__container');
var swiperContainerTrain = document.querySelector('.train__container');
var swiperContainerFeedback = document.querySelector('.feedback__container');
var swiperContainerGallery = document.querySelector('.gallery__container');
var initSwiper = function initSwiper() {
  var swiperHero = new Swiper(swiperContainerHero, {
    ...
    on: {
      slideChange: function slideChange() {
        (0, _initVideo.stopVideo)('hero__video-wrapper');
        (0, _initAudio.stopAudio)('.hero__audio-wrapper');
      }
    }
  });
  var swiperTours = new Swiper(swiperContainerTours, {
    navigation: {
  ...
  var swiperTrain = new Swiper(swiperContainerTrain, {
    navigation: {
  ...
  var swiperFeedback = new Swiper(swiperContainerFeedback, {
    navigation: {
  ...
  var swiperGallery = new Swiper(swiperContainerGallery, {
    navigation: {
...
},{"../audio/init-audio":2,"../video/init-video":14}],14:[function(require,module,exports){
"use strict";
...
exports.stopVideo = void 0;
function initVideo() {
  var video = document.querySelector('.hero__video-wrapper');
  if (!video) {
    return;
  }
  createVideo(video);
...
var regenerateUrl = function regenerateUrl(url) {
...
var stopVideo = function stopVideo(element) {
  ...
  if (containerElement) {
    var iframeTag = containerElement.querySelector('iframe');
    if (iframeTag) {
      var iframeSrc = iframeTag.src;
